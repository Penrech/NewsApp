...
object Deps {
    ...
    const val kotlinParcelizePlugin = "org.jetbrains.kotlin.plugin.parcelize:${Versions.kotlinVersion}"
    ...
    const val paging3 = "androidx.paging:paging-runtime-ktx:${Versions.paging3Version}"
    ...
    const val moshi = "com.squareup.retrofit2:converter-moshi:${Versions.retrofit2Version}"
...
fun DependencyHandler.glide() {
    ...
    add("kapt", Deps.glideCompiler)
}

fun DependencyHandler.paging() {
    fun DependencyHandler.paging() {
        add("implementation", Deps.paging3)
    }
}
